<template>
  <div class="right-board">
    ...
    <div class="field-box">
      ...
      <div class="right-scrollbar sfScroll">
        <!-- 组件属性 -->
        <el-form
        ...
        >
          ...
          >
            <el-slider
              ...
              :max="24"
              :min="1"
              :marks="{ 6: '1/4', 8: '1/3', 12: '1/2', 16: '2/3', 18: '3/4' }"
              @change="spanChange"
            />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item
            ...
            label="按钮类型"
          >
            <el-select v-model="activeData.type" filterable :style="{ width: '100%' }">
            ...
            >
              ...
              <el-form-item label="验证选项">
                <el-select
                  ...
                  :style="{ width: '100%' }"
                  filterable
                  @change="regTypeChange($event, index)"
                >
                  <el-option
                    v-for="(op, i) in regSelectList"
                    :key="i"
                    :label="op.__config__.label"
                    :value="i"
                    >{{ op.__config__.label }}</el-option
                  >
                </el-select>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    regTypeChange(e, index) {
      console.log(e, index,this.regSelectList[e]);
      this.activeData.__config__.regList[index].type = e;
      this.activeData.__config__.regList[index].pattern =
        this.regSelectList[e].__config__.pattern;
      this.activeData.__config__.regList[index].message =
        this.regSelectList[e].__config__.message;
    },
    addSelectItem() {
