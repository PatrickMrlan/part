...
<script>
import { errorLogPage } from "@/api/log";
...
export default {
  ...
  data() {
    return {
      ...
      // 筛选列
      checked: [
        { key: "错误地址", val: "errorUrl", align: "center", minWidth: 100 },
        { key: "IP地址", val: "ipAddress", align: "center", minWidth: 60 },
        { key: "错误信息", val: "errorMsg", minWidth: 240 },
        {
          key: "操作时间",
          val: "addTime",
          align: "center",
