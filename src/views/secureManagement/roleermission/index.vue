<template>
  <div class="table-classic-wrapper">
    ...
    <edit v-if="editShow" :id="editId" :title="titleName" @close="editClose" />
    <Permission
      v-if="permissionShow"
      :role-id="roleId"
...
import Permission from "../../system/userGroup/editAppConfig";
export default {
  ...
  data() {
    return {
      ...
      checked: [
        { key: "角色名称", val: "roleName", width: "150px", align: "center" },
        { key: "角色类型", val: "roleType", width: "120px", align: "center" },
        { key: "角色描述", val: "remake", align: "center" }
      ],
      total: 0,
      // 表格数据数组
      tableData: [],
