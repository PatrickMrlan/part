  ...
  data() {
    return {
      ...
      imgList: [
        {
          id: 1,
          src: require("@/assets/img/bigScreen/background.png"),
          width: 1920,
          height: 1080,
          zoom: 5000,
        },
      ...
      gMap.events.on("featureSelected", (feature) => {
        ...
        if (feature.type === "RECT") {
          ...
          const gFirstMarker = new AILabel.Marker(
            markerId, // id
            {
              src: require("@/assets/img/bigScreen/footer-icon4.png"),
...
.AILabel {
  ...
  #map::after {
    ...
    width: 100%;
    height: 100%;
    background-image: url("../../../assets/img/bigScreen/background.png");
