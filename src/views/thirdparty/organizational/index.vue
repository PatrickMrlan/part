  ...
  methods: {
    ...
    getTreeList() {
      ...
      depTreeList().then(res => {
        ...
        this.listQuery.thirdPartyId = this.nowIndex
    ...
    clearAll() {
      this.listQuery.thirdPartyId = null
    ...
    edit(data) {
      ...
      if (data == null) {
        ...
        this.editId = data.thirdPartyUserId
        this.titleName = '修改用户'
      }
      this.editShow = true
    },
    ...
    remove(data) {
      ...
      if (data == null) {
        for (const item of that.multipleSelection) {
          ...
          deleteData.push(item.thirdPartyUserId)
        }
      } else {
        deleteData = [data.thirdPartyUserId]
      }
