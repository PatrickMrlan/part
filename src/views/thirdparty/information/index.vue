...
<script>
import { list, del } from "@/api/thirdparty/information";
  ...
  methods: {
    ...
    edit(data) {
      if (data && data.thirdPartyId) {
        this.editId = data.thirdPartyId;
        this.titleName = "编辑第三方";
      } else {
        this.editId = null;
        this.titleName = "新增第三方";
      }
      this.editShow = true;
    },
    /**
