  ...
  <div class="setting-container">
    <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px"
      ...
      <el-form-item label="审批说明" prop="flowRemark">
        <el-input v-model="formData.flowRemark" type="textarea"
:rows="6" placeholder="请输入审批说明" :maxlength="100"
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogVisible = false; activeIcon = selectedIcon" size="small">提 交</el-button>
      </span>
    </el-dialog>
  </div>
</template>
