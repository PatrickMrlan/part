      ...
      <div class="transfer__body">
        ...
        <div class="transfer-pane">
          <div class="transfer-pane__tools">
            <el-input v-model="searchString" class="search-input" size="mini" style="width: 180px; display: none;" type="search"
          ...
          <footer class="transfer__footer">
            <el-button type="info" plain size="mini" @click="confirm">提交</el-button>
